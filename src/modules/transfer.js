...
layui.define(
  ['i18n', 'laytpl', 'component', 'form', 'lay'],
  function (exports) {
    'use strict';
    ...
    var component = layui.component({
      ...
      render: function () {
         ...
         * ==================
         *
         * layui transfer 使用 laytpl 模板引擎来生成 HTML 结构，主要包含以下几个模板：
         *
         * 1. TPL_BOX - 单个穿梭框模板
         *    - 负责生成左右两个穿梭框的 HTML 结构
         *    - 支持全选复选框、搜索框、数据列表等功能
         *    - 可通过 obj.index 参数控制是左侧(0)还是右侧(1)穿梭框
         *
         * 2. TPL_MAIN - 主布局模板
         *    - 整个穿梭框组件的外层结构
         *    - 包含左穿梭框、中间操作按钮、右穿梭框等区域
         *
         * 模板语法说明：
         * - {{= }} - 输出变量（会进行 HTML 转义）
         * - {{ if(condition){ }} ... {{ } }} - 条件判断
        ...
        var TPL_MAIN = [
          ...
          '     lay-filter="LAY-transfer-{{= d.index }}">',
          '',
        ...
        /**
         * 渲染 laytpl 模板，CSP 兼容
         * @param {string|((data: Record<string, any>, extra?: any) => string)} tpl 模板字符串或渲染函数
        ...
        var thisElem = (that.elem = $(
          renderLaytpl(
            TPL_MAIN,
            {
              ...
              index: that.index, // 索引
              i18nMessages: {
                transfer_search_placeholder: i18n.$t(

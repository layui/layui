...
layui.define(['laytpl', 'form'], function(exports) {
  ...
  var TPL_BOX = function(obj){
    ...
    return ['<div class="layui-transfer-box" data-index="'+ obj.index +'">',
      ...
      '<div class="layui-transfer-search">',
        ...
        '<input type="text" class="layui-input" placeholder="'+ layui.$t('transfer.searchPlaceholder') +'">',
      '</div>',
      '{{# } }}',
  ...
  Class.prototype.config = {
    ...
    id: '', // 唯一索引，默认自增 index
    text: {
      none: layui.$t('transfer.noData'),
      searchNone: layui.$t('transfer.noMatch')
    }
  };

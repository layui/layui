...
layui.define(['laytpl', 'laypage', 'layer', 'form', 'util'], function(exports){
  ...
  Class.prototype.events = function(){
    ...
    var commonMember = function(sets){
      var othis = $(this)
      ,rowTr = othis.parents('tr').eq(0),index = rowTr.data('index')
      ,tr = that.layBody.find('tr[data-index="'+ index +'"]')
      ...
      return $.extend({
        ...
        ,update: function(fields){ //修改行数据
          ...
          // add By Microanswer 2019年11月2日12:11:57
          ...
          layui.each(toolbarTemps, function (index, value) {
            ...
            if (tempStr) {
              ...
              rowTr.find("td[data-off='true'] div"+ELEM_CELL+".laytable-cell-1-" + key).html(result);
            }
          });
        }
      }, sets);

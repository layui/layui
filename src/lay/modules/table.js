...
layui.define(['laytpl', 'laypage', 'layer', 'form'], function (exports) {
    ...
    var $ = layui.$
        ...
        //字符常量
        , MOD_NAME = 'table1', ELEM = '.layui-table', THIS = 'layui-this', SHOW = 'layui-show', HIDE = 'layui-hide', DISABLED = 'layui-disabled', NONE = 'layui-none'
    ...
    Class.prototype.events = function () {
        ...
        //单元格编辑
        that.layBody.on('focus', '.' + ELEM_EDIT, function () {
            var othis = $(this)
                , value = this.value
                othis.parent().data('old', this.value);
            ...
            layui.event.call(this, MOD_NAME, 'edit(' + filter + ')', {
                ...
                , data: data
                , field: field
                , old: othis.parent().data('old')
                , update: function (fields) {
                    fields = fields || {};
                    layui.each(fields, function (key, value) {
                        if (key in data) {
                            var templet, td = othis.parents('tr').children('td[data-field="' + key + '"]');
                            data[key] = value;

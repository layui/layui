    ...
    ,items = {
      ...
      select: function(){
        ...
        selects.each(function(index, select){
          ...
          // 解决下拉存在默认值不显示 icon 的情况
            var defaultIconHtml = selected[0].attributes['icon'] === undefined ||
                                  selected[0].attributes['icon'] === null
                              ? ''
                              : '<i class="_wtm-combo-icon ' + selected[0].attributes['icon'].value + '" style="margin-right: 5px;"></i>';

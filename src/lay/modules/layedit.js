...
layui.define(['layer', 'form'], function(exports) {
	...
	Edit.prototype.build = function(id, settings) {
		...
		, editor = $(['<div class="' + ELEM + '">', '<div class="layui-unselect layui-layedit-tool">' + tool + '</div>', '<div class="layui-layedit-iframe">', '<iframe id="' + name + '" name="' + name + '" frameborder="0"></iframe>', '</div>', '</div>'].join(''))

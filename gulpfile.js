...
const config = {
  ...
  //模块
  modules:
    "lay,laytpl,laypage,laydate,jquery,layer,util,dropdown,slider,colorpicker,element,upload,form,table,tree,transfer,carousel,rate,flow,code",
};
...
// cp
const cp = () => {
  return gulp.src("./dist/**/*").pipe(gulp.dest(dest));
};
...
exports.layer = () => {
  ...
  gulp.src("./src/css/modules/layer.css").pipe(gulp.dest(dest + "/src"));

  return gulp.src("./src/modules/layer.js").pipe(gulp.dest(dest + "/src"));
};
...
exports.laydate = () => {
  ...
  // css
  gulp.src("./src/css/modules/laydate.css").pipe(gulp.dest(dest + "src"));

  // js
  return gulp
    .src(["./src/layui.js", "./src/modules/{lay,laydate}.js"])

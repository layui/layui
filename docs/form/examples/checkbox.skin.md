...
<div class="lay-form" lay-filter="form-demo-skin">
    ...
    <div class="lay-col-xs12 lay-col-sm6 lay-col-md3">
      ...
      <div lay-checkbox class="lay-skin-checkcard lay-check-dot" style="height: 100px">
        <div class="lay-skin-checkcard-avatar">
          <i class="lay-icon lay-icon-chrome" style="font-size: 30px"></i>
        </div>
  ...
  <div>
    ...
    <div lay-checkbox class="lay-skin-tag lay-badge">唱</div>
    <input type="checkbox" name="hobby[1]" value="跳" lay-skin="none" checked>
    <div lay-checkbox class="lay-skin-tag lay-badge">跳</div>
    <input type="checkbox" name="hobby[2]" value="rap" lay-skin="none">
    <div lay-checkbox class="lay-skin-tag lay-badge">rap</div>
    <input type="checkbox" name="hobby[3]" value="篮球" lay-skin="none">
    <div lay-checkbox class="lay-skin-tag lay-badge">篮球</div>
  </div>

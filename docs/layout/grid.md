...
<style>
.lay-code-item-preview .lay-row{margin-bottom: 11px;}
.lay-code-item-preview .lay-row:last-child{margin-bottom: 0;}
</style>

- 始终等比例水平排列：

<pre class="lay-code" lay-options="{preview: true, codeStyle: 'max-height: 450px;', layout: ['preview', 'code'], tools: ['full']}">
  <textarea>
<div class="lay-row">
...
<pre class="lay-code" lay-options="{preview: true, layout: ['preview', 'code'], tools: ['full']}">
  <textarea>
<div class="lay-row">
  <div class="lay-col-xs12 lay-col-md8">
    <div class="grid-demo grid-demo-bg1">xs:12/12 | md:8/12</div>
  </div>
  <div class="lay-col-xs6 lay-col-md4">
    <div class="grid-demo">xs:6/12 | md:4/12</div>
  </div>
  <div class="lay-col-xs6 lay-col-md12">
...
<pre class="lay-code" lay-options="{preview: true, layout: ['preview', 'code'], tools: ['full']}">
  <textarea>
<div class="lay-row">
  <div class="lay-col-xs6 lay-col-sm6 lay-col-md4">
    <div class="grid-demo grid-demo-bg1">xs:6/12 | sm:6/12 | md:4/12</div>
  </div>
  <div class="lay-col-xs6 lay-col-sm6 lay-col-md4">
    <div class="grid-demo lay-bg-red">xs:6/12 | sm:6/12 | md:4/12</div>
  </div>
  <div class="lay-col-xs4 lay-col-sm12 lay-col-md4">
    <div class="grid-demo lay-bg-blue">xs:4/12 | sm:12/12 | md:4/12</div>
  </div>
  <div class="lay-col-xs4 lay-col-sm7 lay-col-md8">
    <div class="grid-demo lay-bg-green">xs:4/12 | sm:7/12 | md:8/12</div>
  </div>
  <div class="lay-col-xs4 lay-col-sm5 lay-col-md4">
    <div class="grid-demo lay-bg-black">xs:4/12 | sm:5/12 | md:4/12</div>
  </div>
</div>
  </textarea>
</pre>
...
<div class="lay-row">
  <div class="lay-col-md9">
    <div class="grid-demo grid-demo-bg1">75%</div>
  </div>
  <div class="lay-col-md3">
...
<pre class="lay-code" lay-options="{preview: true, layout: ['preview', 'code'], tools: ['full']}">
  <textarea>
<div class="lay-row lay-col-space1">
  <div class="lay-col-md3">
...
<div class="lay-row lay-col-space5">
  <div class="lay-col-md4">
...
<div class="lay-row lay-col-space10">
  <div class="lay-col-md9">
...
<div class="lay-row lay-col-space15">
  <div class="lay-col-md7">
    <div class="grid-demo grid-demo-bg1">7/12</div>
  </div>
  <div class="lay-col-md5">
    <div class="grid-demo">5/12</div>
  </div>
</div>
 
<div class="lay-row lay-col-space30">
  <div class="lay-col-md7">
    <div class="grid-demo grid-demo-bg1">7/12</div>
  </div>
  <div class="lay-col-md5">
...
<div class="lay-row">
  ...
  <div class="lay-col-md4 lay-col-md-offset4">
    <div class="grid-demo">偏移4列</div>
  </div>
</div>
 
<div class="lay-row">
  <div class="lay-col-md3 lay-col-md-offset3">
...
<div class="lay-row">
  <div class="lay-col-md5">
    <div class="lay-row grid-demo">
      ...
      <div class="lay-col-md12">
        <div class="grid-demo grid-demo-bg3">内部列</div>
      </div>
    </div>
  </div>
  <div class="lay-col-md7">
    <div class="lay-row grid-demo grid-demo-bg1">
      <div class="lay-col-md12">
...
<table class="lay-table">
  ...
  <tbody>
    <tr>
      <td>1.</td>
      <td>采用 <em>lay-row</em> 来定义行，如：<em>&lt;div class="lay-row">&lt;/div></em> </td>
    </tr>
    <tr>
      <td>2.</td>
      <td>
        采用类似 <em>lay-col-md*</em> 这样的预设类来定义一组列（column），且放在行（row）内。其中：
        <div class="lay-text">
          <ul>
    ...
    <tr>
      <td>4.</td>
      <td>可对列追加类似 <em>lay-col-space5</em>、 <em>lay-col-md-offset3</em> 这样的预设类来定义列的间距和偏移。</td>
    </tr>
    <tr>
      <td>5.</td>
...
<table class="lay-table">
  ...
  <tbody>
    <tr>
      <td>lay-show-*-block</td>
      <td class="lay-text">定义不同设备下的 display: block; * 可选值有：xs、sm、md、lg、xl</td>
    </tr>
    <tr>
      <td>lay-show-*-inline</td>
      <td>定义不同设备下的 display: inline; * 可选值同上</td>
    </tr>
    <tr>
      <td>lay-show-*-inline-block</td>

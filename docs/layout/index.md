...
<pre class="lay-code" lay-options="{preview: 'iframe',style: 'height: 450px;', layout: ['preview', 'code'], tools: ['full','window']}">
  <textarea>
<!DOCTYPE html>
<html>
<head>
...
<body>
<div class="lay-layout lay-layout-admin">
  <div class="lay-header">
    <div class="lay-logo lay-hide-xs lay-bg-black">layout demo</div>
    <!-- 头部区域（可配合layui 已有的水平导航） -->
    <ul class="lay-nav lay-layout-left">
      <!-- 移动端显示 -->
      <li class="lay-nav-item lay-show-xs-inline-block lay-hide-sm" lay-header-event="menuLeft">
        <i class="lay-icon lay-icon-spread-left"></i>
      </li>
      <li class="lay-nav-item lay-hide-xs"><a href="javascript:;">nav 1</a></li>
      <li class="lay-nav-item lay-hide-xs"><a href="javascript:;">nav 2</a></li>
      <li class="lay-nav-item lay-hide-xs"><a href="javascript:;">nav 3</a></li>
    ...
    <ul class="lay-nav lay-layout-right">
      <li class="lay-nav-item lay-hide lay-show-sm-inline-block">
        <a href="javascript:;">
          <img src="//unpkg.com/outeres@0.0.10/img/layui/icon-v2.png" class="lay-nav-img">
          tester
        </a>
        <dl class="lay-nav-child">
      ...
      <li class="lay-nav-item" lay-header-event="menuRight" lay-unselect>
        <a href="javascript:;">
  ...
  <div class="lay-side lay-bg-black">
    <div class="lay-side-scroll">
      <!-- 左侧导航区域（可配合layui已有的垂直导航） -->
      <ul class="lay-nav lay-nav-tree" lay-filter="test">
        ...
        <li class="lay-nav-item"><a href="javascript:;">click menu item</a></li>
        <li class="lay-nav-item"><a href="javascript:;">the links</a></li>
      </ul>
    </div>
  </div>
  <div class="lay-body">
    ...
    <div style="padding: 15px;">
      <blockquote class="lay-elem-quote lay-text">
        Layui 框体布局内容主体区域
      </blockquote>
      <div class="lay-card lay-panel">
        <div class="lay-card-header">
          下面是充数内容，为的是出现滚动条
        </div>

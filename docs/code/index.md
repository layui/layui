...
<pre class="lay-code" lay-options="{preview: true, codeStyle: 'height: 315px;', layout: ['code', 'preview']}">
  <textarea>
<pre class="lay-code code-demo" lay-options="{}">
light theme
light theme
light theme
</pre>
...
<pre class="lay-code code-demo" lay-options="{theme: 'dark'}">
dark theme
dark theme
dark theme
</pre>

<h3 lay-toc="{level: 2, id: 'examples', hot: true}" class="lay-hide">基础用法</h3>

<pre class="lay-code" lay-options="{preview: true, text: {preview: '基础用法'}, codeStyle: 'height: 535px;', layout: ['preview', 'code'], tools: ['full']}">
  <textarea>
